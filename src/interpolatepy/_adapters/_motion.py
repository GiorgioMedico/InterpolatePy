...
Deferred imports from ``interpolatepy.motion.trapezoidal`` and
``interpolatepy.motion.polynomial``
...
if TYPE_CHECKING:
    ...
    from interpolatepy.motion.polynomial import BoundaryCondition as PyBoundaryCondition
    from interpolatepy.motion.polynomial import TimeInterval as PyTimeInterval
    from interpolatepy.motion.polynomial import TrajectoryParams as PolyTrajectoryParams
    from interpolatepy.motion.trapezoidal import InterpolationParams
    from interpolatepy.motion.trapezoidal import TrajectoryParams as TrapTrajectoryParams
...
class PolynomialTrajectory:
    ...
    def multipoint_trajectory(
        ...
        from interpolatepy.motion.polynomial import BoundaryCondition, TimeInterval  # noqa: PLC0415
