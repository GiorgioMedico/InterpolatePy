...
from ._double_s_planner import EPSILON
from ._double_s_planner import plan_trajectory
...
class DoubleSTrajectory:
    ...
    def _plan_trajectory(self) -> None:
        """Compute and store all trajectory phase parameters."""
        plan_trajectory(self)
