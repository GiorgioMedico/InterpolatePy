...
if TYPE_CHECKING:
    ...
    from .shooting import ShootingConfig
    from .shooting import ShootingQuaternionInterpolation
...
_LOCAL = {
    ...
    "ShootingConfig": ("interpolatepy.quaternion.shooting", "ShootingConfig"),
